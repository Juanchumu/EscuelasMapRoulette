...
## Antes de Empezar: 
* [Lee la pagina de la wiki](https://wiki.openstreetmap.org/wiki/ES:Argentina/Educación)
...
* Solo hace un merge con el nodo proporcionado

## En caso contrario:
* Hay que agregar {{tipo}}.
 * Utiliza el nodo proporcionado
