...
columnas_josm <- c("name","oficial_name","amenity","operator:type",
...
* [Descargar este Geojson](https://github.com/Juanchumu/EscuelasMapRoulette/blob/main/josm_UEL_salida_final.geojson) Dataset creado a partir del mapa escolar
...
* Si esta pero el nodo proporcionado difiere
  * 
...
* Si es posible añadir:
  * landuse:education
    * El area total dedicada a {{tipo}} (El terreno)
  * leisure:pitch (Cancha de deportes)
  * leisure:park
    * Area de con juegos de {{tipo}}
  * leisure:schoolyard
    * Patio interno de {{tipo}}
...
* amenity
  * si hay una escuela y un jardin; deberian ser nodos separados.
* house:number [854 vs 802]
  * Si el nodo esta a mitad de cuadra, seguramente sea 854 
* ref:cue
  * Prevalece el suministrado
  * Puede diferir en 0 (ceros), es mejor que tenga los ceros
* isced:level
  * Si tienen 2 ref:cue distintos, deberian ser nodos separados
    * cada uno con su propio isced:level
* email
  * se deberian registrar varios emails separados por ; (punto y coma)
* phone
  * Prevalece el que tenga las caracteristicas
* addr:postcode
  * 1)de tipo "B9999ALF"
  * 2)de tipo "B9999"
* addr:street
  * Si la ubicacion del {{tipo}}
    * es una zona rural, no hay necesidad de añadirlo
    * es una zona urbana, se puede añadir con el nombre de la calle
      * addr:street=Avenida San Martin 
      * addr:street=321 - Calle Falsa
