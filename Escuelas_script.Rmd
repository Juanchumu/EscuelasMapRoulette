...
#djosm <- st_read("josm_UEL_salida_final.geojson")
#dosm <- st_read("MR_UEL_salida_final.geojson")
#Dataset reducido
#gdf <- gdf[4000:4300,]
...
#Elimina el "0 que esta despues del +54"
dosm$phone <- str_replace(dosm$phone, "\\+54\\s*0", "+54 ")
...
table(dosm$`amenity`, useNA="ifany")
...
* education_for:disabled= {{education_for:disabled}}

## Si {{tipo}} ya esta en el mapa:
* Verifique las etiquetas y unifique con los datos proporcionados
  * Siguiendo la [wiki](https://wiki.openstreetmap.org/wiki/ES:Argentina/Educación#Importacion_de_datos_oficiales_a_OSM:)

## En caso contrario:
* Hay que agregar {{tipo}} en la ubicacion {{latitud}} {{longitud}}.
  * y complete las etiquetas y datos, con los proporcionados.
